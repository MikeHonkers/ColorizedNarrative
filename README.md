...
Планируется:
1. Сделать систему выгрузки и загрузки разных частей модели через vLLM.
2. Написать бэкэнд на фласке для доступа к модели.
3. Создать минимальынй gradio интерфейс (под вопросом).
